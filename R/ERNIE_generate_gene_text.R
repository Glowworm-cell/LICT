#' @export
ERNIE_generate_gene_text <- function(positive_gene, negative_gene) {
  ...
  final_instruction <- "更正上一次询问的回复根据下面的额外信息，这次的回复的细胞类型用英文，\n  把所有结果按顺序给我，如果细胞类型没有更改，回复上一次相同的细胞类型给我，不要跳过。"
